...
import CustomerTableRow from "./Widget/CustomerTableRow"; // Child component for table rows

import { users_list, siteconfig } from "../../API/endpoints";
              ...
              {loading ? (
                ...
                <tbody>
                  {res.data.map((customer, index) => (
                    <CustomerTableRow
                      key={index}
                      index={(index+1) + (res.pagination.pageSize * (currentPage-1))}
                      customer={customer}
