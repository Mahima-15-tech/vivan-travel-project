                ...
                <div className="ugf-header container-fluid">
                    <div className="d-flex justify-content-between align-items-center mb-3 w-100">
                        ...
                        <div className="alternet-access">
                            <p>Already have an account? <Link to='/agent-register' className='cu-btn'>&nbsp; Register now!</Link></p>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="ugf-container">
                                <div className="content-wrap">
                                    <div className="ugf-form-block-header">
                                        <h2 className='mb-2'>Login Your Account</h2>
                                        ...
                                        <div className="col-lg-8 offset-lg-2">
                                            <form onSubmit={handleSubmit} id="commentForm">
                                                <div className="row">
                                                    ...
                                                    <button type="submit" className="cus-btn w-100 mt-5">Submit</button>
                                                    <p className="terms">
                                    ...
                                    <div className="alternet-access">
                                        <p>Don't have an account? <Link to='/agent-register' className='cu-btn'>&nbsp; Register now!</Link></p>
                                    </div>
                                </div>
                            </div>
                        </div>
